...
var GLOBAL = {
	...
	initTime: 0,
    oneArgFilters: ['full_lib', 'hdonly', 'lossless', 'lossy', 'multichannel'],
    twoArgFilters: ['album', 'albumartist', 'any', 'artist', 'channels', 'composer', 'conductor', 'encoded', 'file', 'folder', 'format', 'genre', 'label', 'performer', 'title', 'work', 'year'],
    allFilters: [],
    sbw: 0,
    backupCreate: false,
